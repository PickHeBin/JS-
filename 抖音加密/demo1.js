...
window.Headers = function () {
    return 'function Headers() { [native code] }'
}
document = {
    referrer: '',
...
parma = 'device_platform=webapp&aid=6383&channel=channel_pc_web&publish_video_strategy_type=2&source=channel_pc_web&personal_center_strategy=1&pc_client_type=1&version_code=170400&version_name=17.4.0&cookie_enabled=true&screen_width=1925&screen_height=457&browser_language=zh-CN&browser_platform=Win32&browser_name=Chrome&browser_version=120.0.0.0&browser_online=true&engine_name=Blink&engine_version=120.0.0.0&os_name=Windows&os_version=10&cpu_core_num=18&device_memory=2&platform=PC&webid=7300184923003143690&msToken=g2GXWWqZdNvcgdctkf-cLrQnYwv_NfVWlRgWQIq7UpEvPbELmdg4Iw6sPMdemmjnY7RPKvJc6UqZK4Q4T6vKzB1fs0UaH4jNmgkjGM4Dvpc2JYReurqSNbLo8l_wiLs='
console.log(window.abcd(parma))